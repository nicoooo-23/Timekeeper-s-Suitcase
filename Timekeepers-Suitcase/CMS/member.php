...
$sql = "SELECT forename, surname, joined, picture FROM member WHERE mem_id = :id;";
...
$section = '';
$title = $member['forename'] . ' ' . $member['surname'];  // HTML <title>
$description = $title . ' on Timekeeper\'s Suitcase';              // Meta description
?>
...
<main class="container">
    ...
    <section class="header">
        ...
        <img src="uploads/<?= html_escape($member['picture'] ?? 'blank-member.png') ?>"
