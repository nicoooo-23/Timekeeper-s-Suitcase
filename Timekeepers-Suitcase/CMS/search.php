...
$sql = "SELECT cat_id AS id, name FROM category WHERE navigation = 1;"; // SQL to get categories
...
$description = $title . ' on Timekeeper\'s Suitcase';              // Meta description content
?>
